...
def generate_password():
    ...
    include_uppercase = input("Include uppercase letter? (Yes, No): ").lower().strip()
    include_special = input("Include special character? (Yes, No): ").lower().strip()
    include_digit = input("Include digit? (Yes, No): ").lower().strip()
